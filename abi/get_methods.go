...
var KnownGetMethodNameByResultTypes = map[string]string{
	"Dnsresolve_RecordsResult":                   "dnsresolve",
	"GetAmmContractData_StormResult":             "get_amm_contract_data",
	"GetAmmName_StormResult":                     "get_amm_name",
	"GetAmmState_StormResult":                    "get_amm_state",
	"GetAmmStatus_StormResult":                   "get_amm_status",
	"GetAsset_DedustResult":                      "get_asset",
	"GetAssets_DedustResult":                     "get_assets",
	"GetAuctionInfoResult":                       "get_auction_info",
	"GetAuthorityAddressResult":                  "get_authority_address",
	"GetBalancesResult":                          "get_balances",
	"GetBillAddressResult":                       "get_bill_address",
	"GetBillAmountResult":                        "get_bill_amount",
	"GetChannelDataResult":                       "get_channel_data",
	"GetCollectionDataResult":                    "get_collection_data",
	"GetDomainResult":                            "get_domain",
	"GetEditorResult":                            "get_editor",
	"GetExchangeSettings_StormResult":            "get_exchange_settings",
	"GetExecutorBalances_StormResult":            "get_executor_balances",
	"GetExecutorCollectionAddress_StormResult":   "get_executor_collection_address",
	"GetExecutorVaultsWhitelist_StormResult":     "get_executor_vaults_whitelist",
	"GetExpectedOutputs_StonfiResult":            "get_expected_outputs",
	"GetFullDomainResult":                        "get_full_domain",
	"GetJettonDataResult":                        "get_jetton_data",
	"GetLastCleanTimeResult":                     "get_last_clean_time",
	"GetLastFillUpTimeResult":                    "get_last_fill_up_time",
	"GetLockerBillDataResult":                    "get_locker_bill_data",
	"GetLockerDataResult":                        "get_locker_data",
	"GetLockupDataResult":                        "get_lockup_data",
	"GetLpData_MegatonResult":                    "get_lp_data",
	"GetLpMiningData_MegatonResult":              "get_lp_mining_data",
	"GetLpMinterAddress_StormResult":             "get_lp_minter_address",
	"GetLpSwapData_MegatonResult":                "get_lp_swap_data",
	"GetMember_WhalesNominatorResult":            "get_member",
	"GetMembersRaw_WhalesNominatorResult":        "get_members_raw",
	"GetMiningData_MegatonResult":                "get_mining_data",
	"GetMultisigDataResult":                      "get_multisig_data",
	"GetNextAdminAddressResult":                  "get_next_admin_address",
	"GetNextProofInfoResult":                     "get_next_proof_info",
	"GetNftAddressByIndexResult":                 "get_nft_address_by_index",
	"GetNftApiInfoResult":                        "get_nft_api_info",
	"GetNftContentResult":                        "get_nft_content",
	"GetNftDataResult":                           "get_nft_data",
	"GetNominatorDataResult":                     "get_nominator_data",
	"GetOracleData_StormResult":                  "get_oracle_data",
	"GetOrderDataResult":                         "get_order_data",
	"GetParams_WhalesNominatorResult":            "get_params",
	"GetPluginListResult":                        "get_plugin_list",
	"GetPoolAddress_StonfiResult":                "get_pool_address",
	"GetPoolData_StonfiResult":                   "get_pool_data",
	"GetPoolData_TfResult":                       "get_pool_data",
	"GetPoolFullDataResult":                      "get_pool_full_data",
	"GetPoolStatusResult":                        "get_pool_status",
	"GetPositionManagerContractData_StormResult": "get_position_manager_contract_data",
	"GetPowParamsResult":                         "get_pow_params",
	"GetPublicKeyResult":                         "get_public_key",
	"GetReferralCollectionAddress_StormResult":   "get_referral_collection_address",
	"GetReferralData_StormResult":                "get_referral_data",
	"GetReferralVaultsWhitelist_StormResult":     "get_referral_vaults_whitelist",
	"GetReserves_DedustResult":                   "get_reserves",
	"GetRevokedTimeResult":                       "get_revoked_time",
	"GetRouterData_StonfiResult":                 "get_router_data",
	"GetSaleData_BasicResult":                    "get_sale_data",
	"GetSaleData_GetgemsAuctionResult":           "get_sale_data",
	"GetSaleData_GetgemsResult":                  "get_sale_data",
	"GetSpotPrice_StormResult":                   "get_spot_price",
	"GetStakingStatusResult":                     "get_staking_status",
	"GetStatusResult":                            "get_status",
	"GetStorageContractAddressResult":            "get_storage_contract_address",
	"GetStorageContractDataResult":               "get_storage_contract_data",
	"GetStorageParamsResult":                     "get_storage_params",
	"GetSubscriptionDataResult":                  "get_subscription_data",
	"GetSubwalletIdResult":                       "get_subwallet_id",
	"GetTelemintAuctionConfigResult":             "get_telemint_auction_config",
	"GetTelemintAuctionStateResult":              "get_telemint_auction_state",
	"GetTelemintTokenNameResult":                 "get_telemint_token_name",
	"GetTerminalAmmPrice_StormResult":            "get_terminal_amm_price",
	"GetTimeoutResult":                           "get_timeout",
	"GetTorrentHashResult":                       "get_torrent_hash",
	"GetValidatorControllerDataResult":           "get_validator_controller_data",
	"GetVammType_StormResult":                    "get_vamm_type",
	"GetVaultContractData_StormResult":           "get_vault_contract_data",
	"GetVaultData_StormResult":                   "get_vault_data",
	"GetVaultType_StormResult":                   "get_vault_type",
	"GetVaultWhitelistedAddresses_StormResult":   "get_vault_whitelisted_addresses",
	"GetWalletAddressResult":                     "get_wallet_address",
	"GetWalletDataResult":                        "get_wallet_data",
	"GetWalletParamsResult":                      "get_wallet_params",
	"IsActiveResult":                             "is_active",
	"IsClaimedResult":                            "is_claimed",
	"IsPluginInstalledResult":                    "is_plugin_installed",
	"IsStable_DedustResult":                      "is_stable",
	"JettonWalletLockDataResult":                 "jetton_wallet_lock_data",
	"ListNominatorsResult":                       "list_nominators",
	"ListVotesResult":                            "list_votes",
	"RoyaltyParamsResult":                        "royalty_params",
	"SeqnoResult":                                "seqno",
}
